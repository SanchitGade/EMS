          ...
          showCreateModel && (
            <div className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto" 
              ...
              <div onClick={(e) => {e.stopPropagation()}} className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" >
                ...
                <div>
                  <h2 className="text-lg font-semibold text-slate-900"> Add New Employee {`>_<`}</h2>
                  <p className="text-sm text-slate-500 mt-0.5">Create account and employee profile</p>
                </div>
            ...
            editEmployee && (
              <div onClick={() => setEditEmployee(null)} className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/40 backdrop-blur-sm ">
                <div onClick={(e) => e.stopPropagation() } className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in">
                  ...
                  <div className="flex items-center justify-between p-6 pb-0">
                    <div>
                    <h2 className="text-lg font-semibold text-slate-900"> Edit Employee {`x_x`} </h2>
