import { ArrowBigRightDash, ArrowRightIcon, Calendar1Icon, DollarSignIcon, FileTextIcon, LucideArrowBigRight } from "lucide-react";
  ...
  return (
    <>
      <div className="animate-fade-in">
        ...
        <div className="grid grid-col-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
