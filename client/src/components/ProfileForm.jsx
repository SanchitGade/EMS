  ...
  return (
    <>
      <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'> 
        ...
        {error && (
            <div className='bg-rose-50 text-rose-700 p-4 rounded-xl text-sm border border-rose-400 mb-6 flex items-start gap-3'>
        ...
        {message && (
            <div className='bg-emerald-50 text-emerald-700 p-4 rounded-xl text-sm border border-emerald-400 mb-6 flex items-start gap-3'>
        ...
        <div className='space-y-5'>
            ...
            <div>
                <label> Bio </label>
                <textarea name="bio" placeholder='Write a brief bio' defaultValue={initialData.bio || ""}
                 className={`resize-none ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : ""}`} />
                 <p className='text-xs text-slate-300 mt-1.5'>This will display in your profile</p>
            </div>
            {
