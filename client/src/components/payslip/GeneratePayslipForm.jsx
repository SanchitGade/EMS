      ...
      <div className='fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
        ...
        {/********* PLAYSLIPS GENERATION FORM  *********/}
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div>
                    <label className='block text-sm font-medium text-slate-700 mb-2'> Deducation </label>
                    <input type="number" name='deducation' defaultValue='0'/>
                </div>
                </div>
                ...
                <div className='flex justify-end gap-3 pt-2'>
                    ...
                    <button disabled={loading} className='btn-primary flex items-center' type='submit'> {loading && <Loader2 className='w-4 h-4 mr-2 animate-spin'/>}Generate</button>
                </div>
