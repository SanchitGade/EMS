...
const EmployeeForm = ({ initialData, onSuccess, onCancel, color }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      onSuccess
        ? (onSuccess(), toast.success("Done!", { duration: 2000 }))
        : navigate("/employee");
    } catch (error) {
    ...
    <>
      ...
      >
        ...
        <div className="card p-5 sm:p-6">
          <h3 className={`font-medium mb-6 pb-4 border-b ${color}`}>
            {" "}
        ...
        <div className="card p-5 sm:p-6">
          <h3
            className={`text-base font-medium text-slate-900 mb-6 pb-4 border-b ${color}`}
          >
            Employment Details
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
        ...
        <div className="card p-5 sm:p-6">
          <h3
            className={`font-medium text-slate-900 mb-6 pb-4 border-b ${color}`}
          >
            {" "}
            Account Setup{" "}
          </h3>
