...
const EmployeeForm = ({initialData, onSuccess, onCancel, color}) => {
    ...
    <>
      <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
        ...
        <div className='card p-5 sm:p-6'>
            <h3 className={`font-medium mb-6 pb-4 border-b ${color}`}> Personal Information</h3>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea name='bio' defaultValue={initialData?.bio} rows={3} placeholder='Brief Description...' className='resize-none'/>
                </div>
            </div>
        </div>
        ...
        {/* Employment Detail */}
        <div className='card p-5 sm:p-6'>
            <h3 className={`text-base font-medium text-slate-900 mb-6 pb-4 border-b ${color}`}>Employment Details</h3>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'   >
                <div>
        ...
        {/* Account Setup */}
        <div className='card p-5 sm:p-6'>
            <h3 className={`font-medium text-slate-900 mb-6 pb-4 border-b ${color}`}> Account Setup </h3>
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                <div className='sm:col-span-2'>
